...
class CrossDatasetProtocol(Protocol):
    """docstring for CrossDatasetProtocol"""
    ...
    def extract_mid_level_features(self):
        ...
        for trial in self.mlf_trials_b:
            ...
            metainfo_feats_b = self.data_b.metainfo_feats(input_path_b, ['npy'])

            output_path_b = os.path.join(input_path_b, trial["CS"], trial["SDD"], str(trial["DS"]))
